...
const Footer = () => {
    ...
    return (
        <footer className="w-full bg-gradient-to-t from-black via-red-950 to-black border-t border-red-800 py-10 px-6">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-sm md:text-base text-gray-300">
                {/* Logo */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <p>024 626 00 626</p>
                        <p>
                            <a href="mailto:info@nca.org.vn" className="text-red-500 hover:text-red-400 hover:underline">info@nca.org.vn</a>
                        </p>
                        <p>
                            <a href="https://www.nca.org.vn" target="_blank" rel="noreferrer" className="text-red-500 hover:text-red-400 hover:underline">
                                www.nca.org.vn
                            </a>
                        </p>
                    </div>
                    <div>
                        ...
                        <p>0344334880</p>
                        <p>
                            <a href="mailto:info@iecconsulting.com.vn" className="text-red-500 hover:text-red-400 hover:underline">
                                info@iecconsulting.com.vn
                            </a>
                        </p>
                        <p>
                            <a href="https://iecconsulting.com.vn" target="_blank" rel="noreferrer" className="text-red-500 hover:text-red-400 hover:underline">
